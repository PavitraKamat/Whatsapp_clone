    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          ...
          bottomLeft: widget.isSentByMe ? const Radius.circular(10) : Radius.zero,
          bottomRight: widget.isSentByMe ? Radius.zero : const Radius.circular(10),
        ),
        boxShadow: [
          BoxShadow(
  ...
  child: Stack(
    ...
    children: [
      ...
      Container(
        ...
        height: 250,
        decoration: BoxDecoration(
          color: Colors.grey.withOpacity(0.3), // Semi-transparent grey
          borderRadius: BorderRadius.circular(10),
        ),
      ),
