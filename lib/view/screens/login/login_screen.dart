...
//   void handleAuth(ProfileProvider profileProvider) async {
...
//     try {
//       final authService = Provider.of<GoogleSignInProvider>(context, listen: false);
//       if (isLogin) {
//         await authService.signIn(email, password,profileProvider);
//       } else {
...
//   void handleGoogleSignIn(ProfileProvider profileProvider) async {
//     final authService = Provider.of<GoogleSignInProvider>(context, listen: false);
//     User? user = await authService.signInWithGoogle(profileProvider);
...
//                         SizedBox(height: 20),
//                         ElevatedButton(
//                           onPressed: handleAuth(profileProvider),
...
//                         ),
//                         GestureDetector(
//                           onTap: handleGoogleSignIn(profileProvider),
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildTextField("Email", emailController, Icons.email),
                        _buildTextField("Password", passwordController, Icons.lock, isObscure: true),
                        SizedBox(height: 20),
                        ElevatedButton(
                          onPressed: () => handleAuth(profileProvider),
                          child: Text(isLogin ? "Sign In" : "Sign Up"),
                        ...
                        Row(children: [
                          Expanded(child: Divider(color: const Color.fromARGB(255, 133, 133, 133))),
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 10),
                            child: Text("OR", style: TextStyle(color: Color.fromARGB(255, 133, 133, 133))),
                          ),
                          Expanded(child: Divider(color: Colors.grey)),
                        ]),
                        SizedBox(height: 10),
